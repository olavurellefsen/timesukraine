...
export default () => (
  <AboutContainer>
    <AboutHeader><Trans i18nKey='main-menu.scenario-descriptions' /></AboutHeader>
	  <AboutBody>
	    <i>Базовий</i> сценарій побудований для визначення оптимальної траєкторії розвитку енергетичного сектору для досягнення цільових показників ЕСУ2035, зокрема:
        <AboutList>
