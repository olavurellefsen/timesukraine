  ...
  render() {
    ...
    return (
      <MenuLayout>
        <MenuHeader>
          <MenuHeaderLeft>
            <a href="http://www.sustainability.man.dtu.dk/english/research/energy-systems-analysis">
              <AppLogo src="./images/dtulogo_white.png" alt="logo" />
            </a>
          </MenuHeaderLeft>
          <MenuHeaderRight>
            <a href="http://ief.org.ua/">
        ...
        <MenuPages>
          ...
          <LanguageGroup>
            <LanguageButton
              selected={i18n.languages[0] === "uk"}
              onClick={() => i18n.changeLanguage("uk")}
            >
              UK
            </LanguageButton>
            <LanguageButton
              selected={i18n.languages[0] === "en"}
          ...
          <MenuRoutes>
            ...
            >
              <Trans i18nKey="main-menu.about-the-tool" />
            </MenuItem>
            <MenuItem
              to="/descriptions"
              selected={this.props.selectedChartgroup === "/descriptions"}
            >
              <Trans i18nKey="main-menu.scenario-descriptions" />
            </MenuItem>
            <MenuItem
              to="/recommendations"
              selected={this.props.selectedChartgroup === "/recommendations"}
            >
              <Trans i18nKey="main-menu.recommendations" />
            </MenuItem>
            <MenuItem
              to="/assumptions"
              selected={this.props.selectedChartgroup === "/assumptions"}
            >
              <Trans i18nKey="main-menu.assumptions" />
            </MenuItem>
            <MenuItem
              to="/subscribe"
              selected={this.props.selectedChartgroup === "/subscribe"}
            >
              <Trans i18nKey="main-menu.subscribe-to-updates" />
            </MenuItem>
          </MenuRoutes>
        </MenuPages>
        <MenuSeparatorLine />
        <ScenarioSelection>
          <ScenarioSelectionList
            ...
            dimensionTitle={this.props.t("main-menu.scenarios", {
        ...
        <ToggleDifference onClick={e => this.props.toggleDifference(e)}>
          ...
          >
            <Trans i18nKey="main-menu.scenario-difference" />
          </ToggleSwitchText>
        </ToggleDifference>
        <MenuSeparatorLine />
        <MenuFooter>
          <CopyrightNotice>
            <ExternalLink href="http://www.tokni.com">
              <Trans i18nKey="main-menu.online-version-from-tokni" />
            </ExternalLink>
          </CopyrightNotice>
        </MenuFooter>
      </MenuLayout>
