      ...
      <MainArea>
        ...
        {(props.scenarioSelection.showDifference === false || (props.scenarioSelection.showDifference === true && selectedScenario2 === "")) &&
          <Flex>
            ...
            <StackedBarChart chartName='web1_TPES' chartTitle={t('chart-titles.tpes')} selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label='mtoe' minY={0} maxY={150} minY2={0} maxY2={1} label2="Renewable share" Y2Percentage={true} />
