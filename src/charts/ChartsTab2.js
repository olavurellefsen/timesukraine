    ...
    <NamespacesConsumer>{t =>
      <MainArea>
        ...
        {(props.scenarioSelection.showDifference === true && selectedScenario2 !== "") &&
          <Flex>
            <StackedBarDiffChart chartName='web2_All Electricity Capacity ' chartTitle={t('chart-titles.all-electric-capacity')}  selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label='GW' minY={-100} maxY={100} />
            <StackedBarDiffChart chartName='web2_All Electricity NEW Capac' chartTitle={t('chart-titles.new-capacity')} selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label='GW' minY={-30} maxY={30} />
            <StackedBarDiffChart chartName='web2_All Electricity Productio' chartTitle={t('chart-titles.electric-production-incl-import')} selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label='Billion Kwh' minY={-300} maxY={300} />
            <StackedBarDiffChart chartName='web2_HEAT Production All types' chartTitle={t('chart-titles.heat-production')} selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label='PJ' minY={-12000} maxY={12000} />
            <StackedBarDiffChart chartName='web2_Renewables Electricity Pr' chartTitle={t('chart-titles.electricity-from-renewables')} selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label='Billion Kwh' minY={-120} maxY={120} />
		  </Flex>
        }
      </MainArea>
    }</NamespacesConsumer>
